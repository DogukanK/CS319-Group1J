...
public class BMController {
    ...
    public static boolean signIn(String email,char[] password){
        ...
        ((Student) globalGroupList.get(0).getMembers().get(0)).getReviews().add(u1);
        ((Student) globalGroupList.get(0).getMembers().get(0)).getReviews().add(u2);
        ((Student) globalGroupList.get(0).getMembers().get(0)).getReviews().add(u3);
